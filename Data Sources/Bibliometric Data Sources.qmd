...
## Bibliometric Data Sources: quick summary
...
To work with a bibliometric database we need three things:

1.  Access to the data
2.  Access to a database management system (a server)
3.  Data literacy (SQL)

We can also access the data through the online portals, but the type of analysis we can do are limited:
